...
from src.database.db import check_teacher_exists,create_teacher,teacher_login,get_teacher_subjects,create_student,get_attendance_for_teacher
...
def teacher_tab_take_attendance():
    ...
    with c2:
        if st.button('Run Face Analysis',type='secondary',width='stretch',icon=':material/analytics:',disabled=not has_photos):
            with st.spinner('Deep scanning of classroom photos...'):
                all_detected_ids = {}
