...
def student_screen():
    ...
    if show_registration:
        with st.container(border = True):
            ...
            new_name = st.text_input('Enter your name',placeholder = 'E.g Princi Arjariya')
            ...
            try:
                audio_data = st.audio_input('Record a short phrase for attendance like I am present, my name is princi.')
            except Exception:
